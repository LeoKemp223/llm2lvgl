...
{
    const lv_font_t * f14 = ui_font_get(14);
    const lv_font_t * f24 = ui_font_get(24);
    ...
    lv_obj_set_style_text_font(title, f24, 0);
    ...
    lv_obj_set_style_text_font(item_0, f24, 0);
    ...
    lv_obj_set_style_text_font(item_1, f14, 0);
    ...
    lv_obj_set_style_text_font(item_2, f24, 0);
    ...
    lv_obj_set_style_text_font(item_3, f14, 0);
    ...
    lv_obj_set_style_pad_hor(item_4, 20, 0);
    lv_obj_set_style_pad_ver(item_4, 12, 0);
